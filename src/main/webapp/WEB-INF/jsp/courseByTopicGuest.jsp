...
<head>
    ...
    <style>
        ...
        .pricingTable2 .pricingTable-header{padding:20px 15px 45px;background:#0922c6;-webkit-clip-path:polygon(50% 100%,100% 60%,100% 0,0 0,0 60%);clip-path:polygon(50% 100%,100% 60%,100% 0,0 0,0 60%);position:relative}
        ...
        .pricingTable2 .title{font-size:35px;color:#fff;margin:0}
        ...
        .pricingTable2 .pricing-content li i{color:#ffc11a}
        .pricingTable2 .pricingTable-signup{display:block;padding:18px 0;margin:0 25px;border-radius:10px;background:#ffc11a;font-size:20px;color:#fff;letter-spacing:1px;text-transform:uppercase;overflow:hidden;position:relative;transition:all .3s ease 0s}
        ...
        .pricingTable2.blue .pricingTable-header,.pricingTable2.blue .pricingTable-signup{background:#ffff00}
        .pricingTable2.blue .pricing-content li i{color:#15b8f3}
        .pricingTable2.pink .pricingTable-header,.pricingTable2.pink .pricingTable-signup{background:#ffff00}
        .pricingTable2.pink .pricing-content li i{color:#0922c6}
...
<c:choose>
    <c:when test="${courseByTopic == null || courseByTopic.isEmpty()}"><br/>
        Наразі доступних курсів не знайдено
    </c:when>
    <c:otherwise>
            <div class="container">
                <h1>
