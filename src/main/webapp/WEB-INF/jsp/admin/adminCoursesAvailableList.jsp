...
<html>
<head>
    <title>Admin Courses Available List</title>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            <th><fmt:message key="login.topic"/>
                <c:choose>
                    <c:when test="${sortingMode eq 'DESC'}">
                        <a href="adminCoursesAvailableList?sortingColumn=t.name&sortingMode=ASC"><i class="fa fa-sort-up"></i></a>
                    </c:when>
                    <c:otherwise>
                        <a href="adminCoursesAvailableList?sortingColumn=t.name&sortingMode=DESC"><i class="fa fa-sort-down"></i></a>
                    </c:otherwise>
                </c:choose>
            </th>
            <th><fmt:message key="login.name"/>
                <c:choose>
                    <c:when test="${sortingMode eq 'DESC'}">
                        <a href="adminCoursesAvailableList?sortingColumn=c.name&sortingMode=ASC"><i class="fa fa-sort-up"></i></a>
                    </c:when>
                    <c:otherwise>
                        <a href="adminCoursesAvailableList?sortingColumn=c.name&sortingMode=DESC"><i class="fa fa-sort-down"></i></a>
                    </c:otherwise>
                </c:choose></th>
            <th><fmt:message key="login.dataStart"/>
                <c:choose>
                    <c:when test="${sortingMode eq 'DESC'}">
                        <a href="adminCoursesAvailableList?sortingColumn=c.date_start&sortingMode=ASC"><i class="fa fa-sort-up"></i></a>
                    </c:when>
                    <c:otherwise>
            ...
            <th><fmt:message key="login.duration"/>
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="adminCoursesAvailableList?sortingColumn=c.duration&sortingMode=DESC"><i class="fa fa-sort-down"></i></a>
                    </c:otherwise>
                </c:choose></th>
            <th><fmt:message key="login.teacher"/>
                <c:choose>
                    <c:when test="${sortingMode eq 'DESC'}">
                        <a href="adminCoursesAvailableList?sortingColumn=u.surname&sortingMode=ASC"><i class="fa fa-sort-up"></i></a>
                    </c:when>
                    <c:otherwise>
                        <a href="adminCoursesAvailableList?sortingColumn=u.surname&sortingMode=DESC"><i class="fa fa-sort-down"></i></a>
                    </c:otherwise>
                </c:choose></th>
        ...
        <ul class="pagination">
            <c:if test="${currentPage != 1}">
                <li class="page-item"><a class="page-link"
                                         href="adminCoursesAvailableList?recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}&sortingColumn=${sortingColumn}&sortingMode=${sortingMode}"><fmt:message key="pagin.previous"/></a>
                </li>
            </c:if>
            ...
            <c:forEach begin="1" end="${noOfPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link"
                                                 href="adminCoursesAvailableList?recordsPerPage=${recordsPerPage}&currentPage=${i}&sortingColumn=${sortingColumn}&sortingMode=${sortingMode}">${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:if test="${currentPage lt noOfPages}">
                <li class="page-item"><a class="page-link"
                                         href="adminCoursesAvailableList?recordsPerPage=${recordsPerPage}&currentPage=${currentPage+1}&sortingColumn=${sortingColumn}&sortingMode=${sortingMode}"><fmt:message key="pagin.next"/></a>
                </li>
            </c:if>
        </ul>
    </nav>
