...
/**
 * Controller for all courses by status progress for admin.
 */
@WebServlet(value = "/adminCoursesList")
public class AdminCoursesListServlet extends HttpServlet {
     ...
     *
     * @param req - request object with status progress
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int rows = courseService.getNumberOfRows(CourseDao.SQLTask.GET_COURSE_BY_ADMIN_STATUS_COUNT.getQUERY(), "progress");
